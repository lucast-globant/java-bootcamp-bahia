...
public class MeetingsController {
	...
	@RequestMapping(value = "/createMeeting", method = RequestMethod.POST, headers = "Accept=application/xml, application/json", produces = "application/json")
	public @ResponseBody Meeting addMeeting(@RequestBody Meeting meeting) {
		meetingRepository.addMeeting(meeting);
		return meeting;
	}

	@RequestMapping(value = "/removeMeeting", method = RequestMethod.DELETE, headers = "Accept=application/xml, application/json", produces = "application/json")
	public void removeMeeting(@RequestBody int meeting) {
		meetingRepository.removeMeeting(meeting);

	}

	@RequestMapping(value = "/updateMeeting", method = RequestMethod.PUT, headers = "Accept=application/xml, application/json", produces = "application/json")
