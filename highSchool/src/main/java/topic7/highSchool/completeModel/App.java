...
public class App implements CommandLineRunner {
	...
	public void run(String... strings) throws Exception {
		...
		System.out
				.println("Students who assist to course 1 using findByCourseId(1L)");
		for (Student cs : studentRepository.findByCourseId(1L)) {
			System.out.println(cs.getLastName());
		}
		System.out.println("-------------------------------");

		System.out.println("Courses student2 assists to using findByStudentId(2L)):");
	...
	private void loadExamples() {
		...
		student1.addCourse(course1, 2014, 7, 8, 8, 8);
		student2.addCourse(course3, 2014, 7, 8, 8, 8);
		student3.addCourse(course4, 2014, 7, 8, 8, 8);
		student4.addCourse(course1, 2014, 7, 8, 8, 8);
		student5.addCourse(course2, 2014, 7, 8, 8, 8);
		student6.addCourse(course1, 2014, 7, 8, 8, 8);
		student7.addCourse(course3, 2014, 7, 8, 8, 8);
		student8.addCourse(course1, 2014, 7, 8, 8, 8);
		student9.addCourse(course2, 2014, 7, 8, 8, 8);
		student10.addCourse(course1, 2014, 7, 8, 8, 8);
		student11.addCourse(course2, 2014, 7, 8, 8, 8);
		student12.addCourse(course5, 2014, 7, 8, 8, 8);
		student13.addCourse(course3, 2014, 7, 8, 8, 8);
		student14.addCourse(course1, 2014, 7, 8, 8, 8);
		student15.addCourse(course1, 2014, 7, 8, 8, 8);
		student1.addCourse(course5, 2014, 7, 8, 8, 8);
		student2.addCourse(course1, 2014, 7, 8, 8, 8);
		student3.addCourse(course3, 2014, 7, 8, 8, 8);
		student4.addCourse(course4, 2014, 7, 8, 8, 8);
		student5.addCourse(course1, 2014, 7, 8, 8, 8);
		student6.addCourse(course2, 2014, 7, 8, 8, 8);
		student7.addCourse(course5, 2014, 7, 8, 8, 8);
		student8.addCourse(course3, 2014, 7, 8, 8, 8);
		student9.addCourse(course4, 2014, 7, 8, 8, 8);
		student10.addCourse(course2, 2014, 7, 8, 8, 8);
		student11.addCourse(course3, 2014, 7, 8, 8, 8);
		student12.addCourse(course1, 2014, 7, 8, 8, 8);
		student13.addCourse(course1, 2014, 7, 8, 8, 8);
		student14.addCourse(course2, 2014, 7, 8, 8, 8);
		student15.addCourse(course3, 2014, 7, 8, 8, 8);
		student1.addCourse(course4, 2014, 7, 8, 8, 8);
		student2.addCourse(course2, 2014, 7, 8, 8, 8);
		student3.addCourse(course5, 2014, 7, 8, 8, 8);
		student4.addCourse(course2, 2014, 7, 8, 8, 8);
		student5.addCourse(course5, 2014, 7, 8, 8, 8);
		student6.addCourse(course4, 2014, 7, 8, 8, 8);
		student7.addCourse(course2, 2014, 7, 8, 8, 8);
		student8.addCourse(course4, 2014, 7, 8, 8, 8);
		student9.addCourse(course5, 2014, 7, 8, 8, 8);
		student10.addCourse(course3, 2014, 7, 8, 8, 8);
		student11.addCourse(course1, 2014, 7, 8, 8, 8);
		student12.addCourse(course2, 2014, 7, 8, 8, 8);
		student13.addCourse(course5, 2014, 7, 8, 8, 8);
		student14.addCourse(course3, 2014, 7, 8, 8, 8);
		student15.addCourse(course4, 2014, 7, 8, 8, 8);
