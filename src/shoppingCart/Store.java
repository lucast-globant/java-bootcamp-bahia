...
public class Store {
	...
	public void createExampleProducts() {
		...
		offer.addItem(this.getProduct(1), 1f);
		offer.addItem(this.getProduct(7), 2f);
		offer.addItem(this.getProduct(10), 1f);
		this.addProduct(offer, 10);
		offer = new Offer("FastFood", 35f); // 14
		offer.addItem(this.getProduct(9), 1f);
		offer.addItem(this.getProduct(11), 1f);
		this.addProduct(offer, 100);
		offer = new Offer("Friday&Friends", 99f); // 15
		offer.addItem(this.getProduct(13), 1f);
		offer.addItem(this.getProduct(12), 1f);
		this.addProduct(offer, 100);
